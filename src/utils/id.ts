...
export function generateId(): string {
  ...
  getRandomValues(buf);
  buf[6] = (buf[6]! & 0x0f) | 0x40; // safe: buf has length 16, indices 6/8 in-bounds; version 4
  buf[8] = (buf[8]! & 0x3f) | 0x80; // safe: buf has length 16, indices 6/8 in-bounds; variant 10
